...
def content
  [].tap do |children|
      ...
      children << p({className:"icon"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/youchan.jpg"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"ubiregi"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/ubiregi.png"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"ubiregi-user"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/20thousand.png"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"mpop"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/mpop.png"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"flickorder"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/flickorder.png"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"rpoint"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/rpoint.jpg"}))
  end
end
end
...
def content
  [].tap do |children|
      ...
      children << p({className:"coffee"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/coffee.jpg"}))
  end
end
end
...
def content
  [].tap do |children|
      ...
      children << p({className:"taskboard"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/taskboard.jpg"}))
      children << p({className:"ajile"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/ajile.jpg"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"rollplay"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/rollplay.jpg"}))
  end
end
end
...
def content
  [].tap do |children|
      children << p({className:"kamo"}, img({className: "", src: "assets/coffee_lt_2016-08-03/images/kamo.jpg"}))
  end
end
end
